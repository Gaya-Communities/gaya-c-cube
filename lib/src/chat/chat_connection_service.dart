...
class CubeChatConnection {
  ...
  Future<CubeUser> login(CubeUser cubeUser, {String? resourceId}) async {
    log('[login] userId: ${cubeUser.id}, $resourceId', TAG);
    Completer<CubeUser> completer = Completer();
    ...
    xmpp.XmppAccountSettings account = xmpp.XmppAccountSettings(userJid, jid.local, jid.domain, cubeUser.password!, kIsWeb ? 5291 : 5222,
    ...
    xmpp.Log.logLevel = xmpp.LogLevel.OFF;
